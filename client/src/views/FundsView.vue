<template>
  <div class="content-container">
    <PageHeader title="Funds"
      :text="['In this page, you can take a look at Brazilian stock funds and their portfolio.', 'Feel free to filter and order the results acording to you criteria.']" />
    ...
    <ListItems sublabel="stocks" :items="items" @request-more-items="loadMoreFunds()" />
  </div>
</template>
<script lang="ts">
